...
def sample_ppo_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    net_arch = [
        dict(pi=[net_arch_width] * net_arch_depth, vf=[net_arch_width] * net_arch_depth)
    ]
...
def objective(trial: optuna.Trial) -> float:
    ...
    try:
        model.learn(2000, callback=eval_callback, progress_bar=True)
        env.close()
